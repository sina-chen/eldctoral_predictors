...
p0_r <- ilogit.rv(logit.rv(election_data$vote2_rep) +
                    postrv$mu_alpha + 
                    postrv$beta2*election_data$democracy_mcmc + 
...
saveRDS(b0_summary, "~/results_vis/us_senate_predictable/us_senate_b0_democracy.RDS")
saveRDS(exp_b0_summary, "~/results_vis/us_senate_predictable/us_senate_exp_b0_democracy.RDS")
