...
#   average expected edb face white prob dem
#
...
# simulation results
resStan <- readRDS('~/fit_stan/us_senate_predictable/resStan_us_senate_context1990_2022_face_prob_white_dem.RDS')
...
saveRDS(b0_summary, "~/results_vis/us_senate_predictable/us_senate_b0_minority_face_prob_dem.RDS")
...
# save
saveRDS(avg_b0_summary, "~/results_vis/us_senate_predictable/us_senate_avg_exp_b0_face_prob_white_dem.RDS")
