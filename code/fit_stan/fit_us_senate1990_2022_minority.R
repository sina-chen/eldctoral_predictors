...
stan_dat <- list(
  ...
  feature_dem = vote_sy$minority_dem,
  feature_rep = vote_sy$minority_rep,
  t = polls$t_sc,
...
saveRDS(resStan, '~/fit_stan/us_senate_predictable/resStan_us_senate_context1990_2022_minority.RDS') # xx divergencies, alpha 95, tree 12
