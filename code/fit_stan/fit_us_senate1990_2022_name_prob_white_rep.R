#-------------------------------------------------------------------------------
#
# Electoral predictors - fit name prob. white Rep. model
#
# Author: Sina Chen
#
#-------------------------------------------------------------------------------
...
stan_dat <- list(
  ...
  feature = vote_sy$name_prob_white_rep, # election-level feature
...
saveRDS(resStan, '~/fit_stan/us_senate_predictable/resStan_us_senate_context1990_2022_name_prob_white_rep.RDS')
