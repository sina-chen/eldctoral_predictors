#-------------------------------------------------------------------------------
#
# Electoral predictors - state control
#
#
#-------------------------------------------------------------------------------
...
stan_dat <- list(
  ...
  feature_dem = vote_sy$control_dem,
  feature_rep = vote_sy$control_rep,
  t = polls$t_sc,
...
saveRDS(resStan, '~/fit_stan/us_senate_predictable/resStan_us_senate_context1990_2022_control.RDS') # xx divergencies, alpha 95, tree 12
