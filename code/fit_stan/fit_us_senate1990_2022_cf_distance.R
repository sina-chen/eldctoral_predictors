...
stan_dat <- list(
  ...
  feature = (vote_sy$cf_score_rep - vote_sy$cf_score_dem),
  t = polls$t_sc,
...
saveRDS(resStan, '~/fit_stan/us_senate_predictable/resStan_us_senate_context1990_2022_cf_distance.RDS') # xx divergencies, alpha 95, tree 12
