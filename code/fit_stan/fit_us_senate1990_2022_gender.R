...
stan_dat <- list(
  ...
  feature_dem = vote_sy$gender_dem,
  feature_rep = vote_sy$gender_rep,
  t = polls$t_sc,
...
saveRDS(resStan, '~/fit_stan/us_senate_predictable/resStan_us_senate_context1990_2022_gender.RDS') # 0 divergencies, alpha 95, tree 12, ess warning
